...
tidy the vault (missing ids/times, naming outliers, stale HEADs, unharvested valve).
If $ARGUMENTS is set, treat it as the increment/scope to reconcile; otherwise ask me
what landed.
