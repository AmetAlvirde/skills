...
slices, and stop at approval. The build is a separate session someone else starts.
If $ARGUMENTS is set, treat it as the increment to define; otherwise ask me what we
are defining.
