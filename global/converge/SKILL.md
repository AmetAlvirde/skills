...
Then save per `~/Dev/notes/_saving.md`, and **read it** first. It is the source
of truth for path, frontmatter, HEAD update, wikilinks, and the closing report.
This one: `artifact: grill`, file `<project>/<YYYY-MM-DD>-<topic>-grill.md`,
