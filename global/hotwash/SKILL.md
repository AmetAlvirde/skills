...
2. **Seals the session's daylog** — appends the close: what moved, what carries
...
reconstruct fine; what is mid-thought does not. A stash is not a seal, does not
write back to any HEAD, and does not close the day.
