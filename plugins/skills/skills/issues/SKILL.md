...
description: >-
  ...
  complete, and independently reviewable, then publish them as tracker issues
  after approval. Use on "slice this", "break the spec into issues", after
  `spec` is approved and before `implement`.
---
